...
VALUES (1, 'Cozy Apartment', 'A nice and cozy apartment.', 100.00, 'City Center', 'Apartment'),
...
VALUES (1, 2, '2024-06-01', '2024-06-10', 'CONFIRMED'),
       (2, 2, '2024-07-01', '2024-07-15', 'PENDING');

INSERT INTO tracking (booking_id, status)
VALUES (1, 'CONFIRMED'),
       (2, 'PENDING');

INSERT INTO user_details (id, email, phone, address)
VALUES (1, 'john_doe@example.com', '123-456-7890', '123 Main St, City, Country'),
